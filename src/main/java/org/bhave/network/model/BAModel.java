 ...
 * present in the current interface or the general null {@link NetworkModel#configure(org.apache.commons.configuration.Configuration)
...
public interface BAModel extends NetworkModel {
     ...
     *
     * @param d number of links created each iteration of the network growth
     *
