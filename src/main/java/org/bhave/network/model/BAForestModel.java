 ...
 * <p>
 * You can either use the method {@link BAForestModel#configure(int, long)}
 * present in the current interface or the general  {@link NetworkModel#configure(org.apache.commons.configuration.Configuration)
...
public interface BAForestModel extends NetworkModel {
     ...
     *
     * @param numNodes the number of nodes to be created
     *
     *
